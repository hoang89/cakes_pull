...
public class PullToRefreshWebView extends PullToRefreshBase<WebView>
{
	...
	protected WebView createRefreshableView(Context context, AttributeSet attrs)
	{
		...
		{
			webView = new MyWebviewScrollable(context, attrs);
		}
	...
	@TargetApi(9)
	final class InternalWebViewSDK9 extends MyWebviewScrollable
	{
	...
	public class MyWebviewScrollable extends WebView
	{
		protected OnScrollChangedCallback mOnScrollChangedCallback;

		public MyWebviewScrollable(Context context) {
			super(context);
		}

		public MyWebviewScrollable(Context context, AttributeSet attrs, int defStyle) {
			super(context, attrs, defStyle);
		}

		public MyWebviewScrollable(Context context, AttributeSet attrs) {
			super(context, attrs);
		}
